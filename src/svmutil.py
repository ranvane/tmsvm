...
#modification ÕÅÖªÁÙ zhzhl202@163.com
from svm import *
...
#	else:
#		pass
		#print ("F_Score=%g%%,Recall=%g%%,Presion = %g%%") %(f_score*100,recall*100,presion*100)
		#print("F_Score = %g%% (%d/%d) (classification)" % (ACC, int(l*ACC/100), l))
